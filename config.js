...
const CN_CONFIG = {
  ...
  badges: [
    ...
    { id: 'mestre_genetica',     emoji: '🧬', nome: 'Mestre da Genética',    desc: '100% nas questões de Biologia' },
    { id: 'expert_eletroquimica',emoji: '⚗️', nome: 'Expert em Eletroquímica',desc: '100% nas questões de Química' },
    { id: 'senhor_joule',        emoji: '⚡', nome: 'Senhor do Efeito Joule', desc: '100% nas questões de Física' },
    { id: 'maratonista',         emoji: '⏱️', nome: 'Maratonista',           desc: 'Acumulou 2 horas de estudo no portal' },
    { id: 'consistente',         emoji: '📅', nome: 'Consistente',           desc: 'Acessou o portal em 3 dias consecutivos' },
